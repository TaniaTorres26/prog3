...
public class ControladorSemaforo extends javax.swing.JFrame {

    private String[] animacionPersona = {"contact", "contact2", "high-point", "high-point2", "passing", "passing2", "recoil", "recoil2"};
    ...
    private Timer temporizadorAnimacion = new Timer(200, new ActionListener() {
        public void actionPerformed(ActionEvent e) {
            if (indiceAnimacion % 2 == 0) {
                lblPeaton.setIcon(new ImageIcon(getClass().getResource("/Images/" + animacionPersona[indiceAnimacion / 2] + ".png")));
            } else {
                lblPeaton.setIcon(new ImageIcon(getClass().getResource("/Images/contact.png")));
            }
            indiceAnimacion++;
            if (indiceAnimacion == animacionPersona.length * 2) {
    ...
    private void botonPrioridadActionPerformed(java.awt.event.ActionEvent evt) {
        tiempoRestante += 5;
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(ControladorSemaforo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ControladorSemaforo().setVisible(true);
            }
        });
    }
